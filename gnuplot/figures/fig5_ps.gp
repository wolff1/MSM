...
plot data_file using 1:2 with lines title "{/Symbol F}(2u-3)", "" using 1:3 with lines title "{/Symbol F}(2u-1)","" using 1:4 with lines title "{/Symbol F}(2u+0)","" using 1:5 with lines title "{/Symbol F}(2u+1)","" using 1:6 with lines title "{/Symbol F}(2u+3)","" using 1:7 with lines title "{/Symbol S}{/Symbol F}(2u+v)" lc rgb "red","" using 1:8 with lines title "{/Symbol F}(u)"
set output
pause -1
quit
