...
set yrange [ 0.0 : 2.0 ]
set key box
plot "../../data/figures/Figure1.dat" every :::0::0 using ($2):($3) title "g_0" lc rgb "black", \
"" every :::1::1 using ($2):($3) title "g_1" lc rgb "black", \
"" every :::2::2 using ($2):($3) title "g_2" lc rgb "black", \
"" every :::3::3 using ($2):($3) title "1/r" lc rgb "black"
