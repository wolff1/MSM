...
plot data_file using 1:2 with lines title '$\Phi(2u-3)$', "" using 1:3 with lines title '$\Phi(2u-1)$',"" using 1:4 with lines title '$\Phi(2u+0)$',"" using 1:5 with lines title '$\Phi(2u+1)$',"" using 1:6 with lines title '$\Phi(2u+3)$',"" using 1:7 with lines title '$\sum\limits_{v=-3}^{3}\Phi(2u+v)$' lc rgb "red", "" using 1:8 with lines title '$\Phi(u)$'
set output
pause -1
quit
